...
;
define('utils/h',['vendor/preact'], function (preact) {
  return preact.h
})
;
define('utils/render',['vendor/preact'], function (preact) {
  return preact.render
})
;
define('utils/stopLoader',[],function () {
  let interval = null
...
;
define('components/header',['utils/h'], function (h) {
...
;
define('components/main',['utils/h'], function (h) {
  const Main = function () {
    return {
      render: function () {
...
;
define(
  'components/app',['utils/createClass', 'utils/h', 'utils/stopLoader', 'components/header', 'components/main'],
...
;
define(
  'initApp',['utils/createClass', 'utils/h', 'utils/render', 'components/app'],
